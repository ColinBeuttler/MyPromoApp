...
class PreviewActivity : AppCompatActivity() {
    ...
    val testString = "Contact Name: $contactName, Contact Number: $contactNumber, Display Name: $displayName, Junior: $includeJunior, Job Title: $jobTitle, Immediate Start: $immediateStart, Start Date: $startDate"
